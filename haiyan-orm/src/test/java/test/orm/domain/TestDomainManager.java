...
import haiyan.orm.database.sql.UnitOfWorkSQLDBManager;
...
//		Table table = ConfigUtil.getTable(TEST_DBM.getClass());
		...
		IDatabase db = TableDBManagerFactory.createDatabase(user.getDSN());
		ITableDBManager dbm = new UnitOfWorkSQLDBManager((ISQLDatabase)db);
