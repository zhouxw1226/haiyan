 ...
 *
 */
public interface ITableDBManager extends IDBSession {
	
	IDBRecord createRecord();
	IDBRecord createRecord(Class<?> clz) throws Throwable;
	IDBClear getClear();

	boolean delete(ITableDBContext context, Table table, String[] ids) throws Throwable;
	List<IDBRecord> insert(ITableDBContext context, Table table, List<IDBRecord> records) throws Throwable;
