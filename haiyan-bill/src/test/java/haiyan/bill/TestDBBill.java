...
//			ConfigUtil.setExpUtil(new ExpUtil()); 
//			ConfigUtil.setORMUseCache(true); 
//			CacheUtil.setDataCache(new AppDataCache()); 
//			// 寮�惎ORM澶氱骇缂撳瓨 //			CacheUtil.setDataCache(new EHDataCache()); 
//			// 鍏ㄥ眬鐢ㄧ紦瀛樻鏋�//			ConfigUtil.setDataCache(new EHDataCache()); 
//			// 閰嶇疆鐢ㄧ紦瀛樻鏋�//			ConfigUtil.setExpUtil(new ExpUtil()); 
//			// 鍏ㄥ眬鐢ㄥ叕寮忓紩鎿�//			ConfigUtil.setORMUseCache(true); 
//			// 寮�惎ORM澶氱骇缂撳瓨
//		}
//		{
//			File file;
...
//			IBillDBManager billMgr = BillDBManagerFactory.createDBManager(user.getDSN());
