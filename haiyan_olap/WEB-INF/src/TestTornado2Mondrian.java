 ...
 * 
 */
public class TestTornado2Mondrian {
	...
	public static void main(String[] args) throws Exception {
		String connString = "Provider=mondrian;"
				...
				+ "Catalog=" + FileUtil.path + "/Tornado2.xml;";
		String queryString = ""
		//
		...
		// + " WHERE [城市].[城市名称].[苏州市] ";
		// .members
		String html = new TestTornado2Mondrian().print(connString, queryString)
				.toString();
		FileUtil.String2File(html, "F:/testTornado2Mondrian.html", false);
	}
