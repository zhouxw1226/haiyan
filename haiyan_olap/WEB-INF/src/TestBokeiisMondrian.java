...
public class TestBokeiisMondrian {
	...
	public static void main(String[] args) throws Exception {
		String connString = "Provider=mondrian;"
				...
				+ "Jdbc=jdbc:oracle:thin:@localhost:1521:ORACLE;"
				+ "jdbcUser=bokeiis;" + "jdbcPassword=bokeiis;" + "Catalog="
				+ FileUtil.path + "/bokeiis.xml;";
		String queryString = ""
		//
		...
		// + " WHERE [城市].[城市名称].[苏州市] ";
		// .members
		String html = new TestBokeiisMondrian().print(connString, queryString)
				.toString();
		FileUtil.String2File(html, "F:/testBokeiisMondrian.html", false);
	}
