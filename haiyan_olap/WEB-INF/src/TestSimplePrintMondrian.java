 ...
 * 
 */
public class TestSimplePrintMondrian {
	...
	public static void main(String[] args) throws Exception {
		String connString = "Provider=mondrian;"
				...
				+ FileUtil.path + "/SimpleFoodMart.xml;";
		String queryString = ""
				...
				+ " FROM [Sales] ";
		// + " WHERE [Gender].[F] ";
		String html = new TestSimplePrintMondrian().print(connString,
				queryString).toString();
		FileUtil.String2File(html, "F:/testSimpleMondrian.html", false);
	}
