 ...
 */
public class DisabledOperation implements java.io.Serializable {
     ...
     * haiyan.config.castorgen.DisabledOperation
     */
    public static haiyan.config.castorgen.DisabledOperation unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (haiyan.config.castorgen.DisabledOperation) Unmarshaller.unmarshal(haiyan.config.castorgen.DisabledOperation.class, reader);
    }
