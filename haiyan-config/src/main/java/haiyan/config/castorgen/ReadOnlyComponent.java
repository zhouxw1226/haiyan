 ...
 */
public class ReadOnlyComponent implements java.io.Serializable {
     ...
     * haiyan.config.castorgen.ReadOnlyComponent
     */
    public static haiyan.config.castorgen.ReadOnlyComponent unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (haiyan.config.castorgen.ReadOnlyComponent) Unmarshaller.unmarshal(haiyan.config.castorgen.ReadOnlyComponent.class, reader);
    }
