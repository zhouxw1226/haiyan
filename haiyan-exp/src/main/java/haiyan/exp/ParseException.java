 ...
 * long as you retain the fields.
 */
public class ParseException extends Exception {

	static final int Err_Code = 0;

	static final int Err_Paras_Number = 1;

	static final int Err_Para_Type = 2;

	static final int Err_Para_Fun_Not_Impl = 3; //

	static final int Err_Other = 100;
	 ...
	 * @param message
	 */
	ParseException(SimpleNode node, int errorType, String message) {
		super(message);
		specialConstructor = false;
	}
	 ...
	 * @param errorType
	 */
	ParseException(SimpleNode node, int errorType) {
		super();
		specialConstructor = false;
	}
	...
	ParseException(int errorType, String message) {
		super(message);
		specialConstructor = false;
	}

	private SimpleNode errNode = null;

	void setErrNode(SimpleNode rhs) {
		if (errNode == null) {
			errNode = rhs;
		} else {
			DebugUtil.error("[SimpleNode Error:"+errNode+","+rhs+"]");
		}
	}
