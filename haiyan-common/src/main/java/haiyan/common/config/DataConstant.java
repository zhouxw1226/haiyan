...
public class DataConstant {
	...
	// public static String UPLOAD_SERVICE_PATH = null; // ConfigUtil.getPathName();
	// public static final String LOGIN_DSN = "com.haiyan.common.config.LoginDSN";
	/**
	 * 附件存放路径
	 */
...
//			DELETE_NAME, QUERYEDIT_NAME, SAVE_NAME, PRINT_NAME, SELECT_AND_RETURN_NAME, 
	...
	public static final String COUNT_IGNORE = "COUNT_IGNORE";
	static {
